...
values('jaewoo', '±èÀç¿ì', '1234', 'kimjaewu09@naver.com', 'Àç¿ì¾²');
...
insert into s_post
values (post_num_seq.nextval, '¤¾¤·', 'Å×½ºÆ®Áß', 'jaewoo', sysdate, 'aa');

insert into s_post
values (post_num_seq.nextval, 'hello', 'Å×½ºÆ®Áßddd', 'jaewoo', sysdate, 'bb');
